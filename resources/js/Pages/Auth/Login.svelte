        ...
        <div class="col-12 col-md-6 col-xl-7 d-none d-md-block">
          <div class="d-flex justify-content-center text-light">
            <div class="col-12 col-xl-9">
              ...
              <h2 class="h1 mb-4">Lanjutkan perjalananmu bersama Math Rizz</h2>
              <p class="lead mb-5">Kita usahakan matematika yang menyenangkan itu.</p>
              <div class="text-endx">
            ...
            <div class="card-body p-4 p-md-5">
              <div class="row">
                <div class="col-12">
                  <div class="mb-4">
                    <h3>Masuk</h3>
                    <p>Belum punya akun? <a href="/register" class="text-dark poppins-regular">Buat akun dulu</a></p>
                  </div>
                </div>
              </div>
              <form action="#!">
